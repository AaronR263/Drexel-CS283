...
@test "6 pipes" {
    run "./dsh" <<EOF                
ls | grep dshlib.c | cat | cat | cat | cat | cat
EOF
...
@test "Pipes with quotes and no spaces" {
    run "./dsh" <<EOF                
    ls|grep "dshlib.c"|cat
EOF
...
EOF
    ...
    # Expected output with all whitespace removed for easier matching
    expected_output="testtextdsh3>dsh3>cmdloopreturned0"
...
@test "8 pipes should fail" {
    run "./dsh" <<EOF                
    echo hi | cat | cat | cat | cat | cat | cat | cat | cat
EOF
